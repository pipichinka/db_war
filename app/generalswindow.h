#ifndef GENERALSWINDOW_H
#define GENERALSWINDOW_H
...
#include <QSqlDriver>
namespace Ui {
class GeneralsWindow;
}

class GeneralsWindow : public QMainWindow
{
    Q_OBJECT
...
public:
    explicit GeneralsWindow(QSqlDatabase* db, QWidget *parent = nullptr);
    ~GeneralsWindow();
...
private:
    Ui::GeneralsWindow *ui;
    QSqlRelationalTableModel* model;
};

#endif // GENERALSWINDOW_H
