...
#include <QDateEdit>
GeneralsWindow::GeneralsWindow(QSqlDatabase* db, QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::GeneralsWindow),
...
GeneralsWindow::~GeneralsWindow()
{
    delete ui;
}

void GeneralsWindow::on_buttonAdd_clicked()
{
    ...
    q.prepare("INSERT INTO generals_view (name, work, head, hire_date) "
...
void GeneralsWindow::on_buttonDelete_clicked()
{
